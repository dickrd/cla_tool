...
def test_score():
    import jieba
    score1 = hownet.score(jieba.cut("我非常喜欢这个电影！"))
    score2 = hownet.score(jieba.cut("我觉得这个电影还不错。"))
    score3 = hownet.score(jieba.cut("我不喜欢这个电影。"))
    score4 = hownet.score(jieba.cut("这个电影十分令人讨厌！"))
